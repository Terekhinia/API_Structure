...
def test_get_reqest_user(base, id_user):
    ...
    data = {
        '$.data.id': id_user,
        '$.data.last_name': base.testdata.LAST_NAME[id_user],
        '$.data.first_name': base.testdata.FIRST_NAME[id_user]
    }
    base.asserts.check_response_jesonpath(response=response, data=data)
